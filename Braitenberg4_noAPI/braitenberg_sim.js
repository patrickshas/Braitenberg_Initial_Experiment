...
braitenbergInfo = {
  vehicles: [
    ...
    {x: 300, y: 250, color: "white", angle: 0, baseValues: {left: 4, right: 4, bulb: 0}, sensors: [{position: -Math.PI/4, type: "right", strength: -0.2}, {position: Math.PI/4, type: "left", strength: -0.2}]},
	...
	{x: 350, y: 300, color: "red", angle: 0, baseValues: {left: 3, right: 3, bulb: 0}, sensors: [{position: -Math.PI/4, type: "right", strength: -0.9}, {position: Math.PI/4, type: "left", strength: 0.9}]},
    {x: 370, y: 320, color: "white", angle: 0, baseValues: {left: 1, right: 0, bulb: 0}, sensors: [{position: -Math.PI/4, type: "right", strength: -0.3}, {position: Math.PI/4, type: "left", strength: 3}]},
    {x: 180, y: 100, color: "blue", angle: 0, baseValues: {left: 1, right: 4, bulb: 0}, sensors: [{position: -Math.PI/4, type: "right", strength: 2}, {position: Math.PI/4, type: "left", strength: 2}]},
    {x: 150, y: 150, color: "green", angle: 0, baseValues: {left: 2, right: 0, bulb: 0}, sensors: [{position: -Math.PI/4, type: "right", strength: 0.5}, {position: Math.PI/4, type: "left", strength: 0.5}]},
    {x: 50, y: 250, color: "blue", angle: 0, baseValues: {left: 2, right: 2, bulb: 0}, sensors: [{position: -Math.PI/4, type: "right", strength: 0.2}, {position: Math.PI/4, type: "left", strength: 0.2}]}],
...
function moveVehicle(vehicle) {
  ...
  if (!vehicle.isDragged) {
    ...
    // put a if here to deal with this....
	
	newX1 = Math.max(1, Math.min(newX, simulationInfo.width - simulationInfo.vehicleSize*2));
    newY1 = Math.max(1, Math.min(newY, simulationInfo.height - simulationInfo.vehicleSize*2));
